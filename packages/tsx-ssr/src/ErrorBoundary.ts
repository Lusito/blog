import type { ComponentThis, ComponentChildren, InternalComponent } from "./types";
...
export const ErrorBoundary: InternalComponent<ErrorBoundaryProps> = (props) => new VErrorBoundaryNode(props);
